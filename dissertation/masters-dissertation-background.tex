...
This way, to compute the maximum likelihood probability, $T$ is calculated as presented in Equation~\ref{eq:ps}.
...
%After each environment observation, the transition probabilities $T$ are updated.
%Then a state $i$ is promoted to the top of the priority queue. 
